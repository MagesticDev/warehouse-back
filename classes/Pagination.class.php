<?php
	class Pagination {
		...
		public function getPage($req, $nbr=false){
			if(!$nbr):
				$nbr = 12;
			endif;
			...
			elseif(isset($_GET['numpage']) && $_GET['numpage'] > $nombreDePages):
				header('location: /404'); // si le nombre de page est plus petit que la page courante
			endif;
		...
		public function viewPagination($chemin,$nomget,$total,$courante=1,$affichage=2){
         ...
         */
        public function Url($chemin,$texte,$parametre=false,$valeur=false){
